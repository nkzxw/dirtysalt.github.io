...
- [[file:computer-system-reading.org][Computer System Reading]] 单机系统方面的一些文章
  ...
  - [[file:apue.org][APUE]] Unix环境高级编程(Advanced Programming Unix Environment), W. Richard Stevens的神作


- [[file:linux.org][linux]]
  - [[file:pic.org][pic-code]] PIC位置无关代码内部的原理以及和动态库之间的关系
  - [[file:gcc-asm.org][gcc-assembly]] GCC内嵌汇编代码
  - [[file:encoding.org][encoding]] GB2312/GBK/GB18030/Unicode/UTF16/UTF32/UTF8这几种字符编码格式
  - [[file:linux-proc.org][linux /proc filesystem]] Linux /proc文件系统
