...
有兴趣的话可以看看 [[file:../images/simple-made-easy-slides.pdf][slides]], 强烈推荐结合infoq.com上面的talk一起观看，不然可能不知道作者的思路。
...
file:../images/simple-made-easy-simple.png
...
file:../images/simple-made-easy-4.png

----------
作者用下面这句话，批评了当下浮躁的软件开发风气

file:../images/simple-made-easy-5.png
...
file:../images/simple-made-easy-toolkit.png

为什么这些complex东西为什么complex（将什么纠缠在一起了）？, 而simple的东西为什么simple呢（如何可以通过单一的东西表达出来）？

file:../images/simple-made-easy-complexity-toolkit.png file:../images/simple-made-easy-simplicity-toolkit.png
