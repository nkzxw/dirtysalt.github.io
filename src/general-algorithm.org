...
#note(20150908): 这个问题是 [[https://en.wikipedia.org/wiki/Monty_Hall_problem][Monty Hall Problem]], 可以通过 [[https://github.com/dirtysalt/tomb/blob/master/py/scripts/monty_hall.py][模拟]] 来计算结果
