...
*** 使用lzo
关于如何使用lzo可以参看代码示例 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/ReadLzoInput.java][code on github]]. 下面几点需要说明：
...
如果需要单独使用lzo而不是使用mapreduce来做压缩和解压缩的话，可以参考 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/UseLzoStandadlone.java][code on github]].
...
此外我们还需要为这个类写几个辅助类，但是索性的是辅助类并不是很复杂。
   - InputFormat [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/MessageLzoProtobufInputFormat.java][code on github]]
#+BEGIN_SRC Java
...
#+END_SRC
   ...
   - OutputFormat [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/MessageLzoProtobufOutputFormat.java][code on github]]
#+BEGIN_SRC Java
...
#+END_SRC
   ...
   - Writable [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/MessageLzoProtobufWritable.java][code on github]]
#+BEGIN_SRC Java
...
关于如何使用lzo+protobuf可以参看代码示例 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/UseLzoProtobuf.java][code on github]]. 值得注意的是如果输入为lzo文件的话，那么类型是ProtobufWritable<M>（泛型），如果需要取值的话必须通过setConverter提供类信息。

** 多路输入
*** MultipleInputs
  - 参考代码 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/RunMultipleInputs1.java][code on github]]
...
*** MultipleTableInputFormat
  - 参考代码 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/RunMultipleInputs2.java][code on github]]
  - #note: 在cdh4.3.0下面运行的代码略有变动，存放在 [[file:~/repo/dirtysalt.github.io/codes/java/mr2/src/main/java/com/dirlt/java/mr2/RunMultipleInputs2.java][code on github]]
...
** 多路输出
*** MultipleOutputs
  - 参考代码 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/RunMultipleOutputs.java][code on github]]
  - 支持多个htable和多个文件
...
*** MultipleTableOutputFormat
  - 参考代码 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/RunMultipleTableOutput.java][code on github]]
  - 支持多个htable
...
** 获取集群运行状况
 - 参考代码 [[file:~/repo/dirtysalt.github.io/codes/java/mr/src/main/java/com/dirlt/java/mr/ClusterSummary.java][code on github]]
